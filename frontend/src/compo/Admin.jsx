...
const Admin = () => {
  ...
  const [isCardOpen, setIsCardOpen] = useState(false); // ⬅️ New state to toggle form
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card} onClick={() => setIsCardOpen(!isCardOpen)}>
        <h1 style={styles.title}>📸 Upload Student Images</h1>
